...
MONGO_DB_URI = getenv("mongodb+srv://rahat:rahat@rahat.ncjti.mongodb.net/?retryWrites=true&w=majority&appName=Rahat", None)
...
LOG_GROUP_ID = int(getenv("-1002438219410", ""))
...
# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "-6976744562 -6964538561").split())
...
SUPPORT_CHANNEL = getenv(
    "https://t.me/RM_Movie_Flix", None
)  # Example:- https://t.me/TheYukki
SUPPORT_GROUP = getenv(
    "https://t.me/RM_Support_Group", None
